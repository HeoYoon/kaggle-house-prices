...
data <- data %>%
  mutate(
    ...
    GarageCond = case_when(
      data$GarageCond == "Nothing" ~ 1,
      data$GarageCond == "Po" ~ 2,
      data$GarageCond == "Fa" ~ 3,
      data$GarageCond == "TA" ~ 4,
      data$GarageCond == "Gd" ~ 5,
      data$GarageCond == "Ex" ~ 6
    ),
    PoolQC = case_when(
      data$PoolQC == "Nothing" ~ 1,
      data$PoolQC == "Po" ~ 2,
      data$PoolQC == "Fa" ~ 3,
      data$PoolQC == "TA" ~ 4,
      data$PoolQC == "Gd" ~ 5,
